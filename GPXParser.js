...
gpxParser.prototype.parse = function (gpxstring) {
    ...
    console.log(wpts);
    for (var idx = 0; idx < wpts.length; idx++) {
        var wpt = wpts[idx];
        let pt = {};
        console.log(idx, wpt);
    ...
    for (var idx = 0; idx < rtes.length; idx++) {
        let rte = rtes[idx];
        let route = {};
        ...
        for (var idxIn = 0; idxIn < rtepts.length; idxIn++) {
    ...
    for (var idx = 0; idx < trks.length; idx++) {
        let trk = trks[idx];
        let track = {};
        ...
        for (var idxIn = 0; idxIn < trkpts.length; idxIn++) {
