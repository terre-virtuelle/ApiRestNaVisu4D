...
scenarioEntry = Entry(frame1, width=15)
...
sendButton = Button(frame1 , text = "Send", command=sendScenarioName,background = 'white').grid(column=2, row=1)
...
Button(frame1 , text = "Log NMEA", command=log, background = 'white').grid(column=3, row=1)
...
Button(frame1 , text = "True", command=lambda:true("1"), background = 'green').grid(column=2, row=2)
Button(frame1 , text = "True", command=lambda:true("2"), background = 'green').grid(column=2, row=3)
Button(frame1 , text = "True", command=lambda:true("3"), background = 'green').grid(column=2, row=4)
Button(frame1 , text = "True", command=lambda:true("4"), background = 'green').grid(column=2, row=5)
Button(frame1 , text = "True", command=lambda:true("5"), background = 'green').grid(column=2, row=6)
Button(frame1 , text = "True", command=lambda:true("6"), background = 'green').grid(column=2, row=7)
Button(frame1 , text = "True", command=lambda:true("7"), background = 'green').grid(column=2, row=8)
Button(frame1 , text = "True", command=lambda:true("8"), background = 'green').grid(column=2, row=9)
Button(frame1 , text = "True", command=lambda:true("9"), background = 'green').grid(column=2, row=10)
Button(frame1 , text = "True", command=lambda:true("10"), background = 'green').grid(column=2, row=11)
Button(frame1 , text = "True", command=lambda:true("11"), background = 'green').grid(column=2, row=12)
Button(frame1 , text = "True", command=lambda:true("12"), background = 'green').grid(column=2, row=13)
Button(frame1 , text = "True", command=lambda:true("13"), background = 'green').grid(column=2, row=14)
Button(frame1 , text = "True", command=lambda:true("14"), background = 'green').grid(column=2, row=15)
Button(frame1 , text = "True", command=lambda:true("15"), background = 'green').grid(column=2, row=16)
Button(frame1 , text = "True", command=lambda:true("16"), background = 'green').grid(column=2, row=17)
Button(frame1 , text = "True", command=lambda:true("17"), background = 'green').grid(column=2, row=18)
Button(frame1 , text = "True", command=lambda:true("18"), background = 'green').grid(column=2, row=19)
Button(frame1 , text = "True", command=lambda:true("19"), background = 'green').grid(column=2, row=20)
Button(frame1 , text = "True", command=lambda:true("20"), background = 'green').grid(column=2, row=21)
...
Button(frame1 , text = "False", command=lambda:false("1"), background = 'red').grid(column=3, row=2)
Button(frame1 , text = "False", command=lambda:false("2"), background = 'red').grid(column=3, row=3)
Button(frame1 , text = "False", command=lambda:false("3"), background = 'red').grid(column=3, row=4)
Button(frame1 , text = "False", command=lambda:false("4"), background = 'red').grid(column=3, row=5)
Button(frame1 , text = "False", command=lambda:false("5"), background = 'red').grid(column=3, row=6)
Button(frame1 , text = "False", command=lambda:false("6"), background = 'red').grid(column=3, row=7)
Button(frame1 , text = "False", command=lambda:false("7"), background = 'red').grid(column=3, row=8)
Button(frame1 , text = "False", command=lambda:false("8"), background = 'red').grid(column=3, row=9)
Button(frame1 , text = "False", command=lambda:false("9"), background = 'red').grid(column=3, row=10)
Button(frame1 , text = "False", command=lambda:false("10"), background = 'red').grid(column=3, row=11)
Button(frame1 , text = "False", command=lambda:false("11"), background = 'red').grid(column=3, row=12)
Button(frame1 , text = "False", command=lambda:false("12"), background = 'red').grid(column=3, row=13)
Button(frame1 , text = "False", command=lambda:false("14"), background = 'red').grid(column=3, row=14)
Button(frame1 , text = "False", command=lambda:false("14"), background = 'red').grid(column=3, row=15)
Button(frame1 , text = "False", command=lambda:false("15"), background = 'red').grid(column=3, row=16)
Button(frame1 , text = "False", command=lambda:false("16"), background = 'red').grid(column=3, row=17)
Button(frame1 , text = "False", command=lambda:false("17"), background = 'red').grid(column=3, row=18)
Button(frame1 , text = "False", command=lambda:false("18"), background = 'red').grid(column=3, row=19)
Button(frame1 , text = "False", command=lambda:false("19"), background = 'red').grid(column=3, row=20)
Button(frame1 , text = "False", command=lambda:false("20"), background = 'red').grid(column=3, row=21)
...
def response(x):
    ...
    responseId = 'r'+x
    time = str(datetime.now(timezone.utc).isoformat().replace("+00:00", "Z"))
    request = 'http://'+HOST_NAME+':3003/control?cmd=response&target='+responseId+'&origin='+ORIGIN+'&timestamp=' + time
    print(request)
    requests.put(request)
...
resetButton = Button(frame1, text="Reset",command=reset, background = 'white').grid(column=3, row=22)
